...
if($result) {
    $message = "rpg.sethcoder.com.<br><br>Your new user account is: $userid.<br>Your new password is: $password<br><br>\n";
    $message .= "Click here to login: <a href=\"http://rpg.sethcoder.com/login.php?userid=$userid&password=$password&action=logingo\">rpg.sethcoder.com</a><br><br>\n";
    $message .= "Sincerely, The rpg.sethcoder.com crew...\n";
    mailgo($email,$message,"New account setup!");
    // send email to admins
    $message  = "Sir(s),<br>A new user named [$userid] has joined rpg.sethcoder.com<br>\n";
    $message .= "That is all, ImaComputa out!\n";
