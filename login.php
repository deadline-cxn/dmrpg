...
if($action=="logingo")
{
    ...
    if(mysql_num_rows($result) > 0)
    {
        ...
        echo "<html><head><title>Logged in!</title></head><body bgcolor=ff9900 text=000000><font face=verdana size=1><b>\n";
    ...
    {
      $HTTP_SESSION_VARS["valid_user"] = "invalid_user";
    }
}
...
if($action=="sendpass")
{
    ...
    else
    {
        ...
        if(empty($user))        {            echo "<br><p>That email address is not in our records! You must <a href=join.php>JOIN</a>!</p><br>\n";        }
        else
        {
            ...
            $message.="<p style=\"color: black\">Cick <a href=\"$locate/login.php?userid=$user->name&password=$user->pass&login=fo_shnizzle\">here</a> to login!</p><br>\n";
...
if($action=="forgot") {    forgotform($locate);    include("rpg_footer.php");    exit; }

$hi=$HTTP_SESSION_VARS["valid_user"];
